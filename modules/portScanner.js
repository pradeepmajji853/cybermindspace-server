...
const SERVICE_MAP = {
  ...
  23:    { name: 'Telnet',     risk: 'high',     desc: 'Telnet — unencrypted remote shell, never expose to internet' },
  ...
  445:   { name: 'SMB',        risk: 'high',     desc: 'SMB/CIFS — common ransomware vector (EternalBlue)' },
  ...
  2375:  { name: 'Docker',     risk: 'high',     desc: 'Docker daemon API — full container takeover if open' },
  ...
  3389:  { name: 'RDP',        risk: 'high',     desc: 'Remote Desktop — top target for ransomware' },
  5432:  { name: 'PostgreSQL', risk: 'high',     desc: 'PostgreSQL — should not be public' },
  5900:  { name: 'VNC',        risk: 'high',     desc: 'Virtual Network Computing — often unauthenticated' },
  5985:  { name: 'WinRM',      risk: 'high',     desc: 'Windows Remote Management' },
  6379:  { name: 'Redis',      risk: 'high',     desc: 'Redis — frequently exposed without auth' },
  8000:  { name: 'HTTP-Alt',   risk: 'low',      desc: 'Alternative HTTP / dev' },
  8080:  { name: 'HTTP-Proxy', risk: 'low',      desc: 'Common HTTP proxy / Tomcat' },
  8443:  { name: 'HTTPS-Alt',  risk: 'low',      desc: 'Alternative HTTP' },
  8888:  { name: 'HTTP-Alt',   risk: 'low',      desc: 'Alternative HTTP / Jupyter' },
  9200:  { name: 'Elastic',    risk: 'high',     desc: 'Elasticsearch — frequently leaks data' },
  ...
  27017: { name: 'MongoDB',    risk: 'high',     desc: 'MongoDB — historic source of mass leaks' },
